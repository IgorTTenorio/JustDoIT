'''
---------------------------------------------------------------------------------------------------
    VERSÃO 2.0 - MÓDULO GERENTE LIXEIRA INTELIGENTE
    ...
    incrementado da lixeira. Os valores coletados da Base_2.0 através de comunicação serial serão
    exibidos conforme o número de medidas escolhido, e ao final com o comendo sair será gerado um
    arquivo XLS com log dos dados.
---------------------------------------------------------------------------------------------------
'''
      ...
      if Opcao == "1":
         ...
         for j in range(int(Total_de_Medidas)):
            ...
            if len(PacoteRX) == 52:
               ...
               Peso   = (ad2h * 256 + ad2l)/100.0
           
            print ('Medida = ',j+1,'     Distância em Metros = '     ,Dist_M, ' m','     Distância em Centímetros = '     ,Dist_C,' cm','     Peso = '     ,Peso)     
            ws.write(j+2,0,j+1)
